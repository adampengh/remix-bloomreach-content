        ...
        <div className="mt-16 grid grid-cols-1 gap-8 border-t border-gray-100 pt-16 md:grid-cols-4 lg:grid-cols-6">
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="mt-8 space-y-4 text-sm">
              ...
              <li>
                <a className="group flex gap-1.5" href="#">
            ...
            <div className="mx-auto mt-8 max-w-md sm:ms-0">
              ...
              <form className="mt-4">
                <div className="flex flex-col gap-4 sm:flex-row lg:flex-col lg:items-start">
                  ...
                  <input
                    className="w-full rounded-full border-1 border-black px-6 py-3"
                    type="email"
                    placeholder="Enter your email"
                  />

                  <button
                    className="block rounded-full bg-sky-800 px-8 py-3 font-medium text-white transition hover:bg-sky-800"
                    type="submit"
                  >
                    Subscribe
                  </button>
